...
// TODO Auto-generated method stub
                Intent inte = new Intent(Kirim.this, KirimBuat.class);
                startActivity(inte);
            }
        });
        ma = this;
    ...
    public void RefreshList(){
        ...
        ListView01.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                final CharSequence[] dialogitem = {"Lihat soal", "Update soal",
                        "Hapus soal"};
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        switch(item){
                            case 0 :
                                Intent i = new Intent(getApplicationContext(), KirimLihat.class);
                            ...
                            case 2 :
                                ...
                                db.execSQL("delete from soal where nama = '"+selection+"'");
                                RefreshList();
                                break;
                        }
                    }
